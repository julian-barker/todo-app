...
const ToDo = () => {
  ...
  const { values, handlers } = useContext(ToDoContext);
  ...
  const sorted = list.sort((a, b) => b.difficulty - a.difficulty);
  const sliced = sorted.slice(start, start + displayed);

  return (
    <>
      <header data-testid="todo-header">
        <h2 data-testid="todo-h2">To Do List: {incomplete} items pending</h2>
      </header>
      <ul>
